...
class RectangularRoom(object):
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return sum(tile=='clean' for tile in self.room.values())        
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for trial in range(num_trials):        
        ...
        for robot in range(num_robots):
            #robot_dict[robot] = robot_type(room,speed)
        ...
        while room.getNumCleanedTiles()/room.getNumTiles() < min_coverage:
            ...
            for robot in robot_list:
                #robot_dict[robot].updatePositionAndClean()
                robot.updatePositionAndClean()
            #anim.update(room,robot_list)
            ticks += 1
            #print(str(room.getNumCleanedTiles()/room.getNumTiles()))
        trial_ticks.append(ticks)
        #anim.done()
    mean_ticks = sum(trial_ticks)/len(trial_ticks)
    return mean_ticks
    

# Uncomment this line to see how much your simulation takes on average
print(runSimulation(1, 1.0, 15, 15, 0.75, 3, StandardRobot))
...
# Uncomment this line to see how much your simulation takes on average
print(runSimulation(1, 1.0, 15, 15, 0.75, 3, RandomWalkRobot))
